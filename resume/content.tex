...
\begin{zitemize}
    ...
    \item BOAT Ocean Acoustics Workshop, University of Washington (2025): Two-day intensive workshop on experimental acoustics theory.
\end{zitemize}
\vspace{4pt}
...
\begin{zitemize}
    ...
    \item DesignCon, Santa Clara, CA (2022): Industry conference on high-speed signal integrity measurement and PCB manufacturing.
\end{zitemize}
\vspace{4pt}
